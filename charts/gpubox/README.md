...
- `sccache.enabled=true` adds a foreground `sccache` sidecar, injects default
  client env vars into the main container, and provisions a dedicated 300Gi
  `block` PVC for cache storage.
